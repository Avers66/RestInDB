package avers66.restinmemory.aop;
...
public class LoggingAspect {
    ...
    public void logAfterReturning(JoinPoint joinPoint, Object result) {
        log.info("After returning: {} with result: {}  ", joinPoint.getSignature().getName(), result);
    }
    ...
    public void logThrowing(JoinPoint joinPoint, Exception exception) {
        log.info("After exception from {} with exception ", joinPoint.getSignature().getName(), exception);
    }
